...
/**
 * Title: 404 Block
 * Slug: listorify/block-404
 * Categories: listorify-patterns
 */
$listorify_url = trailingslashit(get_stylesheet_directory_uri());
$listorify_images = array(
    $listorify_url . 'assets/images/404.png',
);
?>
<!-- wp:template-part {"slug":"header","theme":"listorify"} /-->
        ...
        <div class="wp-block-cover is-light" style="padding-bottom:var(--wp--preset--spacing--80);min-height:400px"><span aria-hidden="true" class="wp-block-cover__background has-background-background-color has-background-dim-0 has-background-dim"></span>
            <div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained"}} -->
                <div class="wp-block-group"><!-- wp:image {"align":"center","id":1454,"width":"308px","height":"146px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":["#000000","#00a5ff"]}}} -->
                    <figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url($listorify_images[0]) ?>" alt="" class="wp-image-1454" style="width:308px;height:146px" /></figure>
                    <!-- /wp:image -->
                    ...
                    <h4 class="wp-block-heading has-text-align-center has-small-font-size" style="font-style:normal;font-weight:300;letter-spacing:4px;text-transform:uppercase"><?php esc_html_e('OOPS! Page Not Found!', 'listorify') ?></h4>
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
            </div>
    ...
    <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns -->
        <div class="wp-block-columns"><!-- wp:column {"width":"60%"} -->
            <div class="wp-block-column" style="flex-basis:60%"><!-- wp:heading {"textAlign":"left","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
                <h3 class="wp-block-heading has-text-align-left" style="font-style:normal;font-weight:600"><?php esc_html_e('Helpful Links', 'listorify') ?></h3>
                <!-- /wp:heading -->

                <!-- wp:paragraph -->
                <p><?php esc_html_e('Something went wrong! We couldn\'t find the page you were looking for. But don\'t worry, we heve got some other Links that might be helpful:', 'listorify') ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:column -->
        ...
        <div class="wp-block-columns"><!-- wp:column -->
            <div class="wp-block-column"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}}}} -->
                <h4 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--40)"><?php esc_html_e('Pages', 'listorify') ?></h4>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-column"><!-- wp:heading {"level":4} -->
                <h4 class="wp-block-heading"><?php esc_html_e('Categories', 'listorify') ?></h4>
                <!-- /wp:heading -->
            ...
            <div class="wp-block-column"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}},"border":{"bottom":{"width":"0px","style":"none"}}},"layout":{"type":"default"}} -->
                <div class="wp-block-group alignfull" style="border-bottom-style:none;border-bottom-width:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":4} -->
                    <h4 class="wp-block-heading"><?php esc_html_e('Latest Posts', 'listorify') ?></h4>
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
...
<!-- wp:template-part {"slug":"footer","theme":"listorify"} /-->
        ...
        <div class="wp-block-woocommerce-cart alignwide is-loading">
            ...
            <div class="wp-block-woocommerce-filled-cart-block alignwide">
                ...
                <div class="wp-block-woocommerce-cart-items-block">
                    ...
                    <div class="wp-block-woocommerce-cart-cross-sells-block">
                        ...
                        <h2 class="wp-block-heading has-large-font-size"><?php esc_html_e('You may be interested in…', 'listorify') ?></h2>
                        <!-- /wp:heading -->
            ...
            <div class="wp-block-woocommerce-empty-cart-block alignwide">
                ...
                <div class="wp-block-woocommerce-empty-cart-block">
                    ...
                    <h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php esc_html_e('Your cart is currently empty!', 'listorify') ?></h2>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"align":"center"} -->
                    <p class="has-text-align-center"><a href="/shop/"><?php esc_html_e('Browse store', 'listorify') ?></a></p>
                    <!-- /wp:paragraph -->
                    ...
                    <h2 class="wp-block-heading has-text-align-center"><?php esc_html_e('New in store', 'listorify') ?></h2>
                    <!-- /wp:heading -->
